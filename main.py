...
app = FastAPI(title='Backstract Generated APIs - coll-620de6fab31746c38f0bd0b44671b9b1', debug=False,
              docs_url='/condescending-radhika-61fc920ae54711efa1620242ac12000263/docs',
              openapi_url='/condescending-radhika-61fc920ae54711efa1620242ac12000263/openapi.json')
...
app.include_router(
    router,
    prefix='/condescending-radhika-61fc920ae54711efa1620242ac12000263/api',
    tags=['APIs v1']
)
